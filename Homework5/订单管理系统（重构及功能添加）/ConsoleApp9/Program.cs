...
namespace ConsoleApp9
{
    enum OrderOp
    {
        增加订单 = 1, 删除订单 = 2, 修改订单 = 3, 查询订单 = 4, 查询全部订单 = 5,按订单号排序 = 6, 按订单金额排序 = 7,退出系统 = 8
    }
    ...
    class Order : IComparable
    {
...

        {
            ...
            if (this.Id == o.Id && this.Client == o.Client && this.Price == o.Price)
    ...
    class OrderService
    {
                ...
                for (int j = 0; j < kinds; j++)
                {
                    ...
                    foreach (Order o in orders)
                    {
                        ...
                        if (o.Equals(order))
                        {
                            ...
                            {
                                count2 += 1;
                                for (int k = 0; k <= order.orderDetails.Count; k++)
                                {
                                    if (od.Equals(order.orderDetails[k]))
                                    {
                                        flag = false;
                                    }
                                }
                    ...
                    if (flag == false) orders.Remove(order);
                }
                ...
                case 1:
                    {
                        ...
                        {
                            Console.WriteLine(orders[temp1].orderDetails.ToString());
                        }
        ...
        public void ShowAllOrder(List<Order> orders)
        {
            ...
            foreach (var item in orders)
            {
                ...
                {
                    Console.WriteLine(item.orderDetails.ToString());
                }
                counti++;
            }
